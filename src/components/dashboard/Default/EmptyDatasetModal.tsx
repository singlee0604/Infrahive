...
const EmptyDataSetModal: React.FC<Props> = ({ open, ModalOpen, ModalClose }) => {
                ...
                >
                        <Fade in={open}>
                                <Box sx={style}>
                                        ...
                                        >
                                                An empty dataset will contain no documents, and you can upload documents any time.
                                        </Typography>
...
export default EmptyDataSetModal;
