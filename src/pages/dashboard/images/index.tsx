import { Button, Grid, Paper, Stack, Typography, Card, CardContent, CardActions, Chip } from '@mui/material';
    ...
    <Grid container spacing={2}>
      <Grid item xs={12} lg={12} md={12}>
        <Paper sx={{ width: '100%', p: 5 }}>
          ...
          >
            <Typography variant="h3">OpenAI's Image Models</Typography>
            <Typography variant="body1">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eismod tempor.</Typography>
          ...
          >
            <Typography variant="h3">Stability’s Image Models</Typography>
            <Typography variant="body1">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eismod tempor.</Typography>
            <Card sx={{ width: 248 }} variant="outlined">
              <CardContent sx={{ pb: 0 }}>
                <Stack direction="row" spacing={1}>
