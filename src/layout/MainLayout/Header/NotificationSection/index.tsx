      ...
      >
        <Avatar
          ...
          sx={{
            ...
            background: 'none', //theme.palette.mode === 'dark' ? theme.palette.dark.main : theme.palette.secondary.light,
            color: 'gray', //theme.palette.mode === 'dark' ? theme.palette.warning.dark : theme.palette.secondary.dark,
